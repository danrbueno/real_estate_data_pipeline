...
import pandas as pd
from app.airflow.dags.pipelines.models.base import Base, Session, engine
from app.airflow.dags.pipelines.models.city import City
from app.airflow.dags.pipelines.models.neighborhood import Neighborhood
from app.airflow.dags.pipelines.models.property import Property
from app.airflow.dags.pipelines.models.transaction_type import TransactionType
